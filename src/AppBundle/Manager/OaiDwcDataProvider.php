...
class OaiDwcDataProvider extends ContainerAware implements DataProviderInterface
{
    ...
    {
        $extractor->init(__DIR__.'/../../Recolnat/DarwinCoreBundle/Resources/files', 'example.zip');
    ...
    {
        //var_dump($this->extractor->getCore()->getRecord($identifier));
        //die();
        return $this->extractor->getCore()->getRecord($identifier)->getDatas();
        /*return array(
            'title'       => 'Dummy content',
